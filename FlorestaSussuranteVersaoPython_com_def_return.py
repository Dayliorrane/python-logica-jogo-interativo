...
def caminho_sombras():
    ...
    if resposta == 'uma caveira':
        ...
        print('Você encontrou um baú escondido contendo uma gema preciosa que vale 75 pontos.\n')
        return 75
...
def caminho_luz():
    ...
    if resposta == 'atravessar':
        print('\nResposta correta! Parabéns!')
        print('Você acaba de encontrar uma fonte mágica que restaura sua saúde e adiciona 100 pontos à sua pontuação. \n')
        return 100
...
def caminho_criaturas():
    ...
    if resposta == 'contornar':
        ...
        print('Ela te concede uma habilidade especial de camuflagem, adicionando 50 pontos a sua pontuação. \n')
        return 50
...
# LOOP
while True:
    print('\nExistem três caminhos distintos.')
    escolha =  input('Qual caminho você escolhe? 1, 2 ou 3? ')
    ...
    if escolha == 1:
        pontuacao_total += caminho_sombras()

    elif escolha == 2:
        pontuacao_total += caminho_luz()

    elif escolha == 3:
        pontuacao_total += caminho_criaturas()
